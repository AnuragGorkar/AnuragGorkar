...
<div align="center">
  ...
  <div style="line-height: 0.8; ">✒️ <strong>Random fun fact every morning:</strong> <!-- START FUN FACT -->South Dakota is the only U.S state which shares no letters with the name of it`s capital<!-- END FUN FACT --></div>
</div>
