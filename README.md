...
<div align="center">
  ...
  <div style="line-height: 0.8; ">✒️ <strong>Random fun fact every morning:</strong> <!-- START FUN FACT -->The "save" icon on Microsoft Word shows a floppy disk with the shutter on backwards.<!-- END FUN FACT --></div>
</div>
