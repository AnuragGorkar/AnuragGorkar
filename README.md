...
<div align="center">
  ...
  <div style="line-height: 0.8; ">✒️ <strong>Random fun fact every morning:</strong> <!-- START FUN FACT -->Like fingerprints, everyone's tongue print is different!<!-- END FUN FACT --></div>
</div>
