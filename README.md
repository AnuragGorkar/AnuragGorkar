...
<div align="center">
  ...
  <div style="line-height: 0.8; ">✒️ <strong>Random fun fact every morning:</strong> <!-- START FUN FACT -->James Bond`s car had three different license plates in Goldfinger<!-- END FUN FACT --></div>
</div>
