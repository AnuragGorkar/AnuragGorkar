...
<div align="center">
  ...
  <div style="line-height: 0.8; ">✒️ <strong>Random fun fact every morning:</strong> <!-- START FUN FACT -->The symbol on the "pound" key (#) is called an octothorpe..  <!-- END FUN FACT --></div>
</div>
