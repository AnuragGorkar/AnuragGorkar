...
<div align="center">
  ...
  <div style="line-height: 0.8; ">✒️ <strong>Random fun fact every morning:</strong> <!-- START FUN FACT -->The only 15-letter word that can be spelled without repeating a letter is uncopyrightable.<!-- END FUN FACT --></div>
</div>
