...
<div align="center">
  ...
  <div style="line-height: 0.8; ">✒️ <strong>Random fun fact every morning:</strong> <!-- START FUN FACT -->Illinois has the highest number of personalized license plates than any other state.<!-- END FUN FACT --></div>
</div>
