...
<div align="center">
  ...
  <div style="line-height: 0.8; ">✒️ <strong>Random fun fact every morning:</strong> <!-- START FUN FACT -->If you plant an apple seed, it is almost guaranteed to grow a tree of a different type of apple.<!-- END FUN FACT --></div>
</div>
