...
<div align="center">
  ...
  <div style="line-height: 0.8; ">✒️ <strong>Random fun fact every morning:</strong> <!-- START FUN FACT -->The 57 on the Heinz ketchup bottle represents the number of pickle types the company once had.<!-- END FUN FACT --></div>
</div>
