...
<div align="center">
  ...
  <div style="line-height: 0.8; ">✒️ <strong>Random fun fact every morning:</strong> <!-- START FUN FACT -->%60 of all people using the Internet, use it for pornography.<!-- END FUN FACT --></div>
</div>
